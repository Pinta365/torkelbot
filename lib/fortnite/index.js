...
class Fortnite {
	...
	async generateWeeklyStats(paramPlayers = players, startDate) {
		return await helper.generateWeeklyStats(this.client, paramPlayers, startDate);
	}

	async getWeeklyStats(player) { 
		return await helper.getWeeklyStats(player);
	}
